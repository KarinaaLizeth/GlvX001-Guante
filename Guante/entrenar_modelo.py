...
data = load_and_clean_csv('senias.csv')
...
def segment_data(data, segment_size=15):  # Cambié el tamaño de segmento a 60 como mencionaste
    segments = []
    labels = []
...
joblib.dump(model, 'modelo_senias.pkl')
joblib.dump(scaler, 'scaler_senias.pkl')
